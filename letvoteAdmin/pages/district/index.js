...
const District = (props) => {
    ...
    const columns = [
        ...
        {
            title: 'State Division Name',
            dataIndex: 'state_division_name',
            key: 'state_division_name',
        },
        {
            title: 'Name',
            dataIndex: 'name',
        ...
        },
        {
            ...
            render: (text, record) => {
                return <Space>
                    <a onClick={() => props.history.push(`/district/${record.id}`)}><EyeOutlined /></a>
                    <a onClick={() => props.history.push(`/district/edit/${record.id}`)}><EditOutlined /></a>
