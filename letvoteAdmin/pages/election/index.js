...
const Election = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => {
                return <Space>
                    <a onClick={() => props.history.push(`/election/${record.id}`)}><EyeOutlined /></a>
                    <a onClick={() => props.history.push(`/election/edit/${record.id}`)}><EditOutlined /></a>
        ...
        <Row>
            <Col span={24}>
                <Button
                    ...
                    shape="round"
                    icon={<PlusOutlined />}
                    onClick={() => props.history.push("/election/create")}
